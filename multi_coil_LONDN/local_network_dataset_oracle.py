...
# loading the 4 accleration mask and all the training  undersample  and clean image space image to facilltate the neighbor searching    


image_data_gt_name ='/home/shijunliang/Newproject/ground_turth_image_shape'
image_gt_space_array = os.listdir(image_data_gt_name)
image_gt_space_array = sorted(image_gt_space_array)
# loading the test clean and undersample image space to avoid the confusion between the training noisy image 
image_test_gt_name = '/home/shijunliang/Newproject/test_gt'
image_test_gt_array = os.listdir(image_test_gt_name)
image_test_gt_array = sorted(image_test_gt_array)
...
image_space_data = make_data_list(image_data_name,image_space_array) # four fold image shape
image_gt_space_data = make_data_list(image_data_gt_name,image_gt_space_array)# iamge gt image shape
...
# compute the neighbor between the reference image 
